...
ENCLOSURE_URL_PATTERNS = {
    "tesla": (f"{BASE_URL}/digests/", f"{R2_BASE_URL}/tesla/", f"{R2_BASE_URL}/digests/tesla_shorts_time/"),
    "omni": (f"{BASE_URL}/digests/", f"{R2_BASE_URL}/omni_view/", f"{R2_BASE_URL}/digests/omni_view/"),
