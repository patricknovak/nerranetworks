...
# ElevenLabs API (same as Tesla show)
...
- `ELEVENLABS_API_KEY` - Your ElevenLabs API key (shared with Tesla show)
...
- The script uses the same Patrick voice as Tesla Shorts Time
